document.addEventListener("DOMContentLoaded", function() {
    ...
    document.querySelector("#botao").addEventListener("click", function(event){
        ...
        window.location.href = "http://127.0.0.1:5500/JogoAdivinha/JogoAdivinha/Tela2/TelaDoJogo.html";
    });
});

document.querySelector("#botaoFeedback").addEventListener("click", function(event){

window.location.href = "http://127.0.0.1:5500/JogoAdivinha/JogoAdivinha/Tela3/index.html";
